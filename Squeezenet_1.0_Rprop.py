...
def train(epoch):
    ...
    train_correct    = 0
    train_total      = 0
    optimizer  = optim.Rprop(net.parameters(), lr=lrt ,  etas=(0.5, 1.2), step_sizes=(1e-06, 50))

    
    print('Sqnet_1x_v1.0_Rprop Training Epoch: #%d, LR: %.4f'%(epoch, lrt))
...
#             'optimizer_state_dict': optimizer.state_dict()
        ...
        if not os.path.isdir('./checkpoint/Sqnet_1x_v1.0_Rprop'):
            os.makedirs('./checkpoint/Sqnet_1x_v1.0_Rprop')
        torch.save(state, './checkpoint/Sqnet_1x_v1.0_Rprop/Sqnet_1x_v1.0_Rprop_Cifar10.ckpt')
