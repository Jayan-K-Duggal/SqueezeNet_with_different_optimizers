...
#             'optimizer_state_dict': optimizer.state_dict()
        ...
        if not os.path.isdir('./checkpoint/Sqnet_1x_v1.0_ASGD'):
            os.makedirs('./checkpoint/Sqnet_1x_v1.0_ASGD')
        torch.save(state, './checkpoint/Sqnet_1x_v1.0_ASGD/Sqnet_1x_v1.0_ASGD_Cifar10.ckpt')
